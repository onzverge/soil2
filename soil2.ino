...
// else if (AverageHumidity>=630 && AverageHumidity<800){ 
else if (humidityValue1 >= 630 && humidityValue1 < 800 || humidityValue2 < 630 && humidityValue2 < 800) { // Use 2 sensor reading 
lcd.print(" MOIST");
